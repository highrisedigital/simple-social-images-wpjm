 ...
 */
function ssi_wpjm_has_yoast_custom_og_image( $post_id = 0 ) {
 ...
 * @return bool             True if the post has a custom image and false otherwise.
 */
function ssi_wpjm_has_yoast_custom_twitter_image( $post_id = 0 ) {
 ...
 */
function ssi_wpjm_maybe_remove_yoast_tags( $presenters ) {
	...
	if ( ssi_wpjm_has_yoast_custom_og_image() ) {
	...
	if ( ssi_wpjm_has_yoast_custom_twitter_image() ) {
...
add_filter( 'wpseo_frontend_presenters', 'ssi_wpjm_maybe_remove_yoast_tags' );
